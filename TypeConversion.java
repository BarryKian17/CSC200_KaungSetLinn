...
public class TypeConversion {
    public static void main(String[] args) {
        ...
        System.out.println("asciiValue variable data size : " + Integer.SIZE );
        ...
        System.out.println("number variable data size : " + Integer.SIZE );

        System.out.println("Converted to char: " + convertedChar);
        System.out.println("convertedChar variable data size : " + Character.SIZE );
